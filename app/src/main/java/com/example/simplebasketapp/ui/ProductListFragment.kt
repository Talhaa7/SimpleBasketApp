...
class ProductListFragment: Fragment(), ProductButtonClickListener {
    ...
    override fun onProductListButtonClickListener(productListItemUiModel: ProductLisItemUiModel) {

        mainViewModel.addCartItem(CartListItemUiModel(
            productListItemUiModel.id,
            productListItemUiModel.name,
            productListItemUiModel.price,
            productListItemUiModel.currency,
            productListItemUiModel.image
        ))
